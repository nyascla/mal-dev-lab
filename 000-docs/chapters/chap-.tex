...
\label{sec:red-team-reconocimiento} 

\section{Armamento}
\label{sec:red-team-armamento} 

el objetivo es hacer llegar el implante de sliver a la memoria de la victima si pasar por disco
consideraciones importantes, el tamnyo

adjuntar peso del implante:

Sistema de staging

lluvia de ideas para el bad BadUSB

abrir una powesehell y ejecutar una reverse shell de powesehell
abrir una powershell invisible y ejecutar una reverse shell de powershell
abirr una poweshell invisible y reservar memoria y crear un hilo en ese mismo proceso y ejecutar una shellcode con una reverse shell
lo mismo de antes pero en otro proceso
lo mismo de antes pero con process hollowing

\section{Entrega}
\label{sec:red-team-entrega} 

bad usb

\section{Explotación}
\label{sec:red-team-explotacion} 

en este caso la primera barrera a batir seran las proteccioens de WD sobre powershell

tenemos amsi y WD Protección en tiempo real



\section{Instalación y Persistencia}
\label{sec:red-team-instalacion} 

\section{C2}
\label{sec:red-team-c2} 

\section{Acciones sobre el objetivo}
\label{sec:red-team-acciones} 
