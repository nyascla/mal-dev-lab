...
La disposición de los encabezados, secciones y demás campos, incluyendo los offsets estándar de cada componente, se ilustra detalladamente en la infografía disponible en \cite{peinfografia}.
...
Estos campos permiten al sistema operativo localizar las distintas secciones del PE y gestionar correctamente la memoria virtual del proceso al cargar el ejecutable. La estructura completa y los offsets de cada campo se pueden consultar en la infografía de referencia~\cite{peinfografia}.
...
la dirección real de una función exportada~\cite{x64_get_proc}, así como su versión 
equivalente para arquitecturas x86~\cite{x86_get_proc}.
